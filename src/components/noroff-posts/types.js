 ...
 * @typedef  {Object} NoroffCommentModel
 ...
 * @property {NoroffProfileModel} author - Number of posts a profile created.
...
/**
 * A Post created by a end-user.
 * @typedef  {Object} NoroffProfileModel
 * @property {Number} id - an ID.
...
/**
 * A Post created by a end-user.
 * @typedef  {Object} NoroffPostModel
 * @property {Number} id - an ID.
 ...
 * @property {NoroffProfileModel} author - The profile that created this post.
